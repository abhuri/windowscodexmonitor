...
- Opens a compact native popup on left-click with the app icon in its title bar: gauge, remaining percentage, reset countdown plus exact local reset date/time, watchdog status, refresh action, and auto-start toggle.
